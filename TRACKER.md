...
## In Flight
_v2 complete; **v3 in progress** — Documents (V3-1) + Activity Log (V3-2) merged to `main` (local only). **108/108 tests** on merged main. **Deployment deferred until after v3.** See root `../TRACKER.md` for the full module status._
