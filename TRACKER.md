...
## In Flight
_v2 complete; **v3 started** — Documents & resume tracking (V3-1) merged to `main` (local only). **97/97 tests** on merged main. **Deployment deferred until after v3.** See root `../TRACKER.md` for the full module status._
